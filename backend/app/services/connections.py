...
# Порог косинуса для связи. Откалиброван 0.73 на реальных заметках (2026-06-13):
# на этом уровне связи осмысленны (мемы↔мемы, голосовые↔голосовые), мусора нет.
# ≠ порог дедупа 0.85. Стартовым дефолтом был 0.75.
SIMILAR_THRESHOLD = 0.73
